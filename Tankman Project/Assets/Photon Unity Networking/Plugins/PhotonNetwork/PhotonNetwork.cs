...
public static class PhotonNetwork
{
    ...
    /// Connect(serverAddress, <udpport|tcpport>, appID, GAME_VERSION)
    ///
    ...
    /// <summary>Overwrites the region that is used for ConnectToBestCloudServer(string GAME_VERSION).</summary>
    /// <remarks>
