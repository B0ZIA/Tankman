...
public class Zapora : Photon.MonoBehaviour {

    public RodzajZapory rodzajZapory;
    public Sprite zasiekNormalny;
    public Sprite zasiekZniszczony;
    public Sprite zabSmokaNormalny;
    public Sprite zabSmokaZniszczony;
    public Sprite stalowyXNormalny;
    public Sprite stalowyXZniszczony;
    public Sprite plotZniszczony;
    public GameObject poleDoNiszczenia;
    public GameObject poleDoNaprawy;
    public bool jestemZniszczony=false;

    Sprite destroyedTexture;

    //0 i 0 dla zasieków, 0 i 1 dla zębów smoka
    int tankTierToDestroy = 0;
    int tankTierToDestroy2 = 1;
    int tankTierToDestroy3 = 1;
